...
1. [ ] The window narrows:
	* https://www.nytimes.com/2022/10/28/us/politics/ufo-military-reports.html
	* Sadly, more research seems to be slowly ticking off more and more mundane causes for unexplained phenomenon.
	* The saddest thing being that more recent observations, which are captured with more data and an eye towards explanation, are almost all coming back with mundane causes.
	* What was so exciting about the revelations in the last year was that it created a gap, into which the possibility that it COULD be aliens fit.
	* It was never the *likely* explanation, but for a while it was within the realm of the *possible* -- which was different than it had been for decades before the revelations.
	* With each new recent explanation though, the gap has narrowed, and the explanation being aliens has become less and less likely.
	* It's still *possible* but rapidly getting less and less so. Barring wild new data (never say that won't happen -- see election 2016), it will soon be in the realm of the explanation being aliens is *extremely* unlikely.
	* That's not to say there isn't still the strange and the amazing that slips beyond the bounds of science.
	* (Maybe this is the last Mort Rye post)
2. [X] because it's MORE interesting than the stuck boat, but few people are talking about it
...
3. [X] what we know is true now --- unexplained objects in the sky that go zip --- should be considered in light of the long history of people seeing these objects that do _exactly_ the same thing. 
...
4. [X] What it is not -- foreign tech:
...
5. [X] What it is not -- optical illusions: (possibly combined with 5)
...
10. [X] There's a certain kind of smart person who is going around spreading a certain kind of ignorance:
...
11. [ ] How the UFOs could be not-aliens:
...
12. [ ] publish notes in germs: science-vs-magic
	* [ ] see also note in germs: magic-is-rare
13. [ ] science vs magical thinking
...
14. [ ] why now? pandemic? who knows, but it will be one of the interesting things we'll find out some day.
...
15. [ ] The reason aliens are so exciting is because it would show us alternative models. We don't have to be the way we are.
	* (Though I'm not sure how our cultures through history and around the world don't already show us alternative models)	
16. [X]  ufos, next step after report release: start gathering all the reports ppl have from the last 80 years to one db
...
19. [ ] psychiatrists who believe in telling the future -- the future is set just as solidly as the past 
20. [ ] interpretation of dreams is broken to science (teeth! tidal waves! -- people all over the world, but science basically has nothing to say about it)
21. [ ] The thing required for finding out the truth about UFOs, simulations, precognition, etc? Unfortunately, patience.
